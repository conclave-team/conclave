...
class CRDT {
  ...
  handleLocalInsert(val, index) {
    ...
    this.insertAndUpdate(index, newChar, 'local');
  ...
  handleRemoteInsert(char) {
    ...
    this.insertAndUpdate(index, char, 'remote');
  }
  ...
  insertAndUpdate(index, char, opType) {
    this.insertChar(index, char);
    this.insertText(char.value, index);
    this.controller.updateText();

    if (opType === 'local') {
      this.controller.updateCursor();
    } else {
      this.controller.updateCursor('insert', index);
    }
  }
  ...
  handleRemoteDelete(char) {
    ...
    this.controller.updateText();
    this.controller.updateCursor('delete', index);
  }
