...
class CRDT {
  ...
  handleLocalInsert(val, index) {
    ...
    this.insertAndUpdate(index, newChar, val === '\t');
  ...
  insertChar(char) {
    ...
    this.insertAndUpdate(index, char, true);
  }
  ...
  insertAndUpdate(index, char, update) {
    this.insert(index, char);
    this.insertText(char.value, index);
    if (update) { this.controller.updateEditor(); }
  }
  ...
  handleLocalDelete(idx) {
    ...
    this.deleteText(idx);
    if (deletedChar.value === '\t') { this.controller.updateEditor(); }
