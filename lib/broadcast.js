class Broadcast {
  ...
  connectNeighbor(peerId, siteId, newPeerZone){
    console.log('\tDEBUG:\t CONNECTNEIGHBOR SUCCESS');
    ...
    console.log('\tDEBUG:\tNeighbor zone: ' + newPeerZone);
  }
  ...
  zoneTake(xStart,xEnd,yStart,yEnd,Gen) { //split zone by new peer
    console.log("\tDEBUG:\tZone Take Running");
    ...
    console.log("\tDEBUG:\t=======ZONE OF THIS PEER: " + this.region);
    console.log("\tDEBUG:\t=======GENVAL: " + this.genValue);
  }

  zoneShare() { //split zone by original owner
    console.log("\tDEBUG:\tZone Share Running");
