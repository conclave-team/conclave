...
class Controller {
  constructor(targetPeerId, host, peer, broadcast, editor, doc=document, win=window) {
    ...
    if (targetPeerId == 0) {
      ...
      this.broadcast.region = "0,10,0,10";
      ...
      this.broadcast.genValue = "";
      
      console.log('\tDEBUG:\ INITIAL CARTESIAN SPACE: ' + this.broadcast.region);
      console.log('\tDEBUG:\ INITIAL GENVAL: ' + this.broadcast.genValue);
      console.log('\t\t\tTESTING');
