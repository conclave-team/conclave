...
const script1 = `Conclave is a private and secure real-time collaborative text editor.
Conclave allows you to create and edit documents with multiple people all at the
same time.

### How Do I Use It?

To start editing, click the *New Document* link above, and then click the blue
boxes icon to copy the *Sharing Link* to your clipboard. Share the link with
whoever you'd like to collaborate with.
...
could access them. With Conclave, your document is stored only on your computer
and any changes you make are sent only to the people collaborating with you.
Also Google is pretty big. We're just three engineers who created Conclave
in a month. Click *Our Team* above to find out who we are.
