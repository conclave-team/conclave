...
const textarea1 = document.getElementById('edit-1');
const textarea2 = document.getElementById('edit-2');
const editor1 = new Editor(textarea1);
const editor2 = new Editor(textarea2);
editor1.crdt.conns.push(editor2.crdt);
