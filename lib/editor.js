...
//          this.processInsert(changeObj);    // uncomment this line for palindromes!
  ...
  //     this.remoteCursors[siteId] = new RemoteCursor(this.mde, siteId)
  //   }
  // }
  //
  ...
  updateEditorRemote(newText, opType, index, char) {
    ...
    this.insertRemoteCursor(char.siteId, position);
  ...
  insertRemoteCursor(siteId, position) {
    const remoteCursor = new RemoteCursor(this.mde, siteId);
    remoteCursor.set(position);
